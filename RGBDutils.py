        ...
        for root, _, fnames in sorted(os.walk(dRGB)):
            ...
            for fname in sorted(fnames):
                if is_image_file(fname):
                    ...
                    pathDepth = pathRGB.replace('/rgb/', '/depth/')
...
class ImageFolder(data.Dataset):
    """An RGB-D data loader where the images are arranged in this way: ::
        root/rgb/class1/1.png
        root/rgb/class2/1.png
        root/rgb/class3/1.png
        ...
        root/depth/class1/1.png
        root/depth/class2/2.png
        root/depth/class3/3.png
        ...
    Args:
